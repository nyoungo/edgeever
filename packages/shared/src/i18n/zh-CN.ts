...
export const zhCN = {
  companion: {
    ...
    "actions": {
      ...
      "addTags": "仅追加：{{tags}}",
      "mergeHelp": "按上方顺序保留全文与附件，不做 AI 改写或删减；保留已有标签，结果放在第一篇笔记所在的笔记本。原笔记进入回收站，原公开分享失效。可从回收站恢复原笔记，但这不等于一键撤销全部合并效果。建议 24 小时后失效。",
      "tagHelp": "只给这篇笔记追加列出的标签，不删除已有标签，也不修改正文。确认时会重新校验笔记版本；建议 24 小时后失效。",
      "dismiss": "忽略建议",
      "openResult": "打开处理后的笔记",
    ...
    "backupHelp": "预览数据尚未纳入笔记 ZIP 备份，也不支持原生移动端或桌面离线同步。请单独导出记忆、聊天与整理记录；导入只合并记忆、不恢复聊天或整理记录。导出文件包含明文，请妥善保管。",
    "export": "导出记忆与聊天",
    "import": "导入记忆",
    "clearHistory": "清空聊天记录",
    "useMemory": "使用已保存记忆",

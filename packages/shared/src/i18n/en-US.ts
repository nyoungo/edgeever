...
export const enUS = {
  companion: {
    ...
    "backupHelp": "Preview data is not included in note ZIP backups or native mobile / desktop offline sync. Export memories, chats and organization records separately. Import merges memories only, not chats or organization records. Exports contain plaintext; keep them safe.",
